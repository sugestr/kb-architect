...
**Для Codex** — скопируй или свяжи каталог
`plugins/kb-architect/skills/kb-architect` с каталогом пользовательских скиллов
Codex. Канонический источник остаётся репозиторием; перед заменой существующей
копии сравни деревья и сохрани резервную копию. Метаданные интерфейса лежат в
`agents/openai.yaml` рядом со скиллом.
