...
квитанция не посылается. Доставка — не внесение: адресат цитирует message_id в
изменённом каноне или пишет строку реестра разбора; иначе kb_debts.py называет
конверт долгом. -->
