...
это также означает запись в его INDEX. Перед повторным запросом ищи message_id
в inbox и существующей истории источника. Не отправляй сообщение ради
«прочитал/проверил/закоммитил/готово» без дельты. Квитанция: «получено
<message_id>: новое / уже есть / расходится / TBD». На квитанцию квитанция не
посылается. -->
